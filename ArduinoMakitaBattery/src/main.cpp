...
#define ARDUINO_MB_VERSION_MAJOR 0
/** Minor version number (x.X.x) */
#define ARDUINO_MB_VERSION_MINOR 2
/** Patch version number (x.x.X) */
#define ARDUINO_MB_VERSION_PATCH 1
...
void read_usb() {
    if (Serial.available() >= 4) {
        ...
        switch(cmd) {
            case 0x01:
                rsp[0] = 0x01;
                rsp[2] = ARDUINO_MB_VERSION_MAJOR;
                rsp[3] = ARDUINO_MB_VERSION_MINOR;
                rsp[4] = ARDUINO_MB_VERSION_PATCH;
                break;
            case 0x31:
                makita.reset();
                delayMicroseconds(400);
